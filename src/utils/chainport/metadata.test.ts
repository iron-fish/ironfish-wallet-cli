...
describe('ChainportMemoMetadata', () => {
  test('convertNumberToBinaryString converts a number to binary string with padding', () => {
    expect(ChainportMemoMetadata.convertNumberToBinaryString(5, 8)).toBe(
      '00000101',
    )
  })
  ...
  test('encode encodes networkId, address and to_ironfish flag correctly', () => {
    expect(
      ChainportMemoMetadata.encode(
        2,
        '0x5DF170F118753CaE92aaC2868A2C25Ccb6528f9a',
        false,
      ),
    ...
    expect(
      ChainportMemoMetadata.encode(
        22,
        '0x7A68B1Cf1F16Ef89A566F5606C01BA49F4Eb420A',
        true,
      ),
  ...
  test('decode decodes encoded hex string correctly', () => {
    expect(
      ...
      2,
      '0x5DF170F118753CaE92aaC2868A2C25Ccb6528f9a'.toLowerCase(),
      false,
    ])
    ...
    expect(
      ...
      22,
      '0x7A68B1Cf1F16Ef89A566F5606C01BA49F4Eb420A'.toLowerCase(),
      true,
    ])
  })
